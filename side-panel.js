...
const btnReload = Wrapper.createById('reload-button')
const btnStopPrompt = Wrapper.createById('stop-prompt-button')
const btnSubmitPrompt = Wrapper.createById('submit-prompt-button')
const downloadEta = Wrapper.createById('download-eta')
const downloadProgress = Wrapper.createById('download-progress')
const chatLoadingAnimation = Wrapper.createById('chat-loading-animation')
const optSystemLang = Wrapper.createById('option-sys-lang')
const optUserLang = Wrapper.createById('option-user-lang')
const optAssistantLang = Wrapper.createById('option-assistant-lang')
const optStreaming = Wrapper.createById('option-streaming')
const optSysPrompt = Wrapper.createById('option-system-prompt')
const optTemp = Wrapper.createById('option-temperature')
const optTopK = Wrapper.createById('option-top-k')
const pastChats = Wrapper.createById('chat-history')
const promptApiInit = Wrapper.createById('prompt-api-init')
const promptApiUi = Wrapper.createById('prompt-api-ui')
const promptTokens = Wrapper.createById('prompt-tokens')
const promptInput = Wrapper.createById('prompt-input')
const tokenPerSecondStatus = Wrapper.createById('token-per-second')
const durationStatus = Wrapper.createById('duration')
const promptStats = Wrapper.createById('prompt-stats')
const statsTimeToFirstToken = Wrapper.createById('time-to-first-token')
const statsInferenceDuration = Wrapper.createById('inference-duration')
const usageRatio = Wrapper.createById('usage-ratio')
const sessionEstablished = Wrapper.createById('session-established')
const chatPlaceholder = Wrapper.createById('chat-placeholder')
const version = Wrapper.createById('version')
const downloadStatus = Wrapper.createById('download-status')
